class Solution:
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        while i < j: # Since if i is the last_idx then the only remaining soln is i==j which is not allowed
        ...
        return [] # If no soln is found but we are told there will be one
